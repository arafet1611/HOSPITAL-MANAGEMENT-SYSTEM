...
const TableView = () => {
  ...
  return (
    <div className="container">
      ...
      {submitted && rowsData.length <= 0 ? (
       <div className="d-flex justify-content-center align-items-center vh-100">
       <div className="text-center">
         <h2 className="text-center">
           Aucun tableau n'a été trouvé pour le service{" "}
           <strong>{selectedService}</strong> ce mois-ci (
           <strong>{month}</strong>).
         </h2>
         <img src={EmptyBox} alt="Empty Box" className="d-block mx-auto" />
         <h2 className="text-center">
           Vous pouvez créer un tableau pour le service{" "}
         ...
         <button
           ...
           onClick={() => {
             ...
             navigate(
               `/secretary/table-entry/${encodeURIComponent(
                 selectedService
               )}?month=${month}&selectedServiceId=${selectedServiceId}`
             );
           }}
         >
           Créer un tableau
                ...
                <div className=" table-entry-button-wrapper">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      console.log(encodeURIComponent(selectedService));
                      navigate(
                        `/secretary/table-modify/${encodeURIComponent(
                          selectedService
                        )}?month=${month}&selectedServiceId=${selectedServiceId}`
                      );
                    }}
                  ...
                  {DataHistory.map((data) => (
                    ...
                    >
                      <div className="d-flex w-100 justify-content-between">
                        ...
                        <small>
                          {data.dateOfChange.toString().substring(0, 10)}
                        </small>
                      </div>
                      <p className="mb-1">
