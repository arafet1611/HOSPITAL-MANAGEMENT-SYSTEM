...
import EmployeePermutationDemandeTable from "./EmployeePermutationDemandeTable";
function EmployeeDemandeTable() {
    ...
    const fetchLeaveRequests = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/api/demandeLeave/employee/${employeeId}`
        );
  ...
  return (
    ...
    <h2 className="text-center">
        Liste des <strong className="text-primary">demandes de congé</strong> envoyées
    </h2>
</div>
    ...
    <EmployeePermutationDemandeTable />
    </>
  );
}  

export default EmployeeDemandeTable
const styles = `
  .filter {
